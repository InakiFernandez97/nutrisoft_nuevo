        ...
        <aside class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <!-- Brand Logo -->
            <a href="vistas/index3.html" class="brand-link elevation-4">
                <img src="vistas/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">NutriSoft</span>
            </a>
